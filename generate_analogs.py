...
def main():
    ...
    parser.add_argument('--input_frag',
                        nargs='?',
                        const=False,
                        type=str,
                        help='Enter a smiles string for input')
    parser.add_argument('--lead',
                        nargs='?',
                        const=False, type=str, 
                        help='Enter a corresponding lead for which to compare docking score in fragment-lead-pair-style experiments')
    parser.add_argument("--sample",
                        nargs="?",
                        const=False,
                        type=int,
                        help='Enter a number for size of random sample of generated molecules')
    parser.add_argument("--remove_odd_rings",
                        action="store_true",
                        help="Flag to filter out molecules containing odd ring systems")
    parser.add_argument("--dock",
                        action="store_true",
                        help="Flag to run the docking pipeline after reinvent")
    parser.add_argument("--pdb",
                        nargs="?",
                        const=False,
                        type=str,
                        help='Enter the prefix of a .pdb/.sdf file')
